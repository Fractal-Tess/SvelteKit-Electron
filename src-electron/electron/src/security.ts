...
export const applySecurityRestrictions = () => {
  /**
   * A list of allowed permissions for each origin that have been allowed.
   *
  ...
  /**
   * A list of allowed origins that are allowed to be opened inside of the default browser.
